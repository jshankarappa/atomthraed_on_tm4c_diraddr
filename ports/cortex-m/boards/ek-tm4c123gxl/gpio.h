 ...
 *
 * These are usable across all GPIO registers, except GPIO_LOCK and GPIO_PCTL
 * ---------------------------------------------------------------------------*/
 ...
 *
 * param[in] gpioport GPIO block register address base gpio_reg_base
 ...
 * GPIO0, bit 1 to GPIO1. and so on. Masked pins (corresponding bit of gpios
 * parameter set to zero) are returned not affected.
 *
 * This is an atomic operation.
 *
 * param[in] gpioport GPIO block register address base @ref gpio_reg_base
 * param[in] gpios  gpio_pin_id. Any combination of pins may be specified
 *		    by OR'ing then together.
